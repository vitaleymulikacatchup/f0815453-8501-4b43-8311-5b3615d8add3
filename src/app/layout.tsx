...
export const metadata: Metadata = {
  title: "Allen Design Studio | Creative Visual Experiences",
  description: "Discover the creativity and innovation at Allen Design Studio, where visual experiences come to life.",
  openGraph: {
    title: "Allen Design Studio | Creative Visual Experiences",
    description: "Discover the creativity and innovation at Allen Design Studio, where visual experiences come to life.",
    siteName: "Allen Design Studio"
  },
  twitter: {
